...
df = pd.read_csv('atlanta_ga_6_7_18_round_2_phone_1.csv')
...
for name in names:
	...
	df_temp = df_temp[df_temp.columns.tolist()[8:]]
	...
	s.write(1, 1, name[0] + '_' + name[1] + '_survey_1')	# id string

	fileName = 'Atlanta_'+name[0]+'-'+name[1]+'_'+month+'_'+day+'_'+year+'.xls'
