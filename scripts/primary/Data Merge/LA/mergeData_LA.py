...
if __name__ == '__main__':
	...
	# get 3br 2ba addresses
	df = pd.read_csv('LA_trulia_tract_05_21_18.csv')
	...
	df = pd.read_csv('los_angeles_timestamp_status_sheet_5_21_2018.csv')
	...
	for i in range(1, 67):
		...
		tempDF = df[cols]
		tempDF = tempDF.loc[tempDF['address ' + str(i)] != ' ']
	...
	cols = [cols[118]] + cols[81:83] + [cols[119]] + [cols[98]] + [cols[87]] + [cols[117]] + [cols[0]] + cols[120:] + cols[1:81] + cols[83:87] + cols[88:98] + cols[99:117]
	df = df[cols]

	df.to_csv('Trulia_MERGED_allTimestamps_MERGED_allResponses.csv', index=False)
	print('Trulia_MERGED_allTimestamps_MERGED_allResponses.csv has been written. \n')
