...
input_file <- "~/trulia/stores/los_angeles_ca_rental_house.csv"

input_points <- read.csv(input_file)
input_points <- input_points[which(!is.na(input_points$Longitude) & !is.na(input_points$Latitude)),]
points <- input_points
...
polygons_path <- paste0("~/trulia/stores/06/tl_2016_06_tabblock10.shp") # "~/share/projects/zillow/stores/CensusBlocks/09/tl_2016_09_tabblock10.shp"
